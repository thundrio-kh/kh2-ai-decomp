...
pop is_rtn_change_dir ; (bool) 
---
---
---
description: Return if the RTN is changing direction
---
---
---
decompiled code:
bool __fastcall YS::NPC::is_rtn_change_dir(YS::NPC_0 *const this)
/----- (0000000000659714) ----------------------------------------------------
void __fastcall Ti::trap_is_rtn_change_dir(BD_VALUE_26 *args)
{
  __int64 v2; // r29
  ...
  *(_DWORD *)args = YS::NPC::is_rtn_change_dir((YS::NPC_0 *const)*(unsigned int *)(v2 + 4));
}
// 659738: variable 'back_chain' is possibly undefined
->
/----- (00000000004F0110) ----------------------------------------------------
bool __fastcall YS::NPC::is_rtn_change_dir(YS::NPC_0 *const this)
{
  return (_cntlzw((unsigned __int8)(*this)[2660]) & 0x20) == 0;
}
