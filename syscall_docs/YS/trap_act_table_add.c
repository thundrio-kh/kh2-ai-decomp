...
---
---
push table ; (YS::ACT::TABLE *) (The action table that will get a action added to it)
push name ; (string)  (name to represent the action)
push priority ; (int)  (what priority to treat this action. Most actions use a priority of 100)
push entry ; (int) (Line number to routine to process the action)
push callback1 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
push callback2 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
push callback3 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
push callback4 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
push callback5 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
push callback6 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
push callback7 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
push callback8 ; (int)  (Optional line number to callback routine to process after the entry routine. Value of 0 for unused callback)
syscall 1, 6 ; trap_act_table_add (12 in, 0 out)
---
---
---
description: Adds an label to an action table, as an action that can be performed
---
---
---
decompiled code:
