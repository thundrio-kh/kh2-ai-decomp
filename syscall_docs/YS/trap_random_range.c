...
---
---
push min_value ; (float)  (Floor of possible random range)
push unk2 ; (unknown)  (Ceiling of possible random range)
syscall 0, 18 ; trap_random_range (2 in, 1 out)
pop num ; (float) 
---
---
---
description: Return a random float between the two values
---
---
---
decompiled code:
