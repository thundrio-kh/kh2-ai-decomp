...
---
---
push unk1 ; (unknown)  (pushFromFSp: 0,4) (pushFromPSpVal: 0) (pushFromPSp: 80) (pushFromPWp: W0)
...
---
decompiled code:
__int64 __fastcall YS::MOTION::is_in_loop(YS::MOTION_289 *const this)
/----- (0000000000504868) ----------------------------------------------------
void __fastcall YS::trap_obj_is_motion_in_loop(BD_VALUE_21 *args)
{
  __int64 v2; // r29
  ...
  *(_DWORD *)args = YS::MOTION::is_in_loop((YS::MOTION_289 *const)(unsigned int)(*(_DWORD *)(v2 + 4) + 320));
}
// 50488C: variable 'back_chain' is possibly undefined
->
/----- (000000000045CD10) ----------------------------------------------------
__int64 __fastcall YS::MOTION::is_in_loop(YS::MOTION_289 *const this)
{
  ...
  v2 = 0LL;
  v3 = (unsigned int *)*(unsigned int *)&(*this)[12];
  if ( (_DWORD)v3 )
  {
    if ( *(float *)&(*this)[52] <= 0.0 )
    {
      v4 = *(float *)&(*this)[48];
      if ( v4 >= ((double (*)(void))*(unsigned int *)*(unsigned int *)(*v3 + 0x1CLL))() )
        v2 = 1LL;
    }
  }
  return v2;
