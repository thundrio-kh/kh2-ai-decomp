...
/----- (0000000000501158) ----------------------------------------------------
void __fastcall YS::trap_obj_unit_group(BD_VALUE_21 *args)
{
  __int64 v2; // r29
  ...
  *(_DWORD *)args = *(unsigned __int16 *)(*(unsigned int *)(*(unsigned int *)(*(unsigned int *)(v2 + 4) + 0x818LL) + 8LL)
                                        + 2LL);
}
// 50117C: variable 'back_chain' is possibly undefined
->
/----- (0000000000014500) ----------------------------------------------------
// local variable allocation has failed, the output may be wrong!
