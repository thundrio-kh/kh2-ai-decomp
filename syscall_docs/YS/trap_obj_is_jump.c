...
---
---
push unk1 ; (unknown)  (pushFromPSpVal: 0) (pushFromFSp: 0,4)
...
/----- (0000000000504140) ----------------------------------------------------
void __fastcall YS::trap_obj_is_jump(BD_VALUE_21 *args)
{
  __int64 v2; // r30
  ...
  *(_DWORD *)args = (*(_DWORD *)(*(unsigned int *)(*(unsigned int *)(v2 + 4) + 0xCLL) + 8LL) & 1) != 0;
}
// 504164: variable 'back_chain' is possibly undefined
