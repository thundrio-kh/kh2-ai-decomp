...
---
decompiled code:
void __fastcall YS::PIERROT::set_sheet(YS::PIERROT_6 *const this, __int64 param)
/----- (00000000004F2AA8) ----------------------------------------------------
void __fastcall YS::trap_btlobj_set_sheet(BD_VALUE_19 *args)
{
  __int64 v2; // r30
  ...
  YS::PIERROT::set_sheet((YS::PIERROT_6 *const)v4, *(int *)&(*args)[4]);
}
// 4F2ACC: variable 'back_chain' is possibly undefined
->
/----- (000000000047B83C) ----------------------------------------------------
void __fastcall YS::PIERROT::set_sheet(YS::PIERROT_6 *const this, __int64 param)
{
