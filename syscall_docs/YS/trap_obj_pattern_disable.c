...
---
---
push unk1 ; (unknown)  (pushFromFSp: 0) (pushFromPSp: 112,16,32) (pushFromPSpVal: 0)
push unk2 ; (unknown)  (pushImm: 1,10,12,14,2,20,3,4,5,6,7,8,9)
...
/----- (00000000004F8B74) ----------------------------------------------------
void __fastcall YS::trap_obj_pattern_disable(BD_VALUE_21 *args)
{
  __int64 v2; // r30
...
// 4F8B98: variable 'back_chain' is possibly undefined
