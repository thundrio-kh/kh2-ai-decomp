...
/----- (00000000005003F8) ----------------------------------------------------
void __fastcall YS::trap_obj_can_look(BD_VALUE_21 *args)
{
  __int64 v2; // r29
  ...
  v5 = (YS::OBJ_117 *)*(unsigned int *)(v2 + 4);
  if ( !(_DWORD)v4 )
  {
    ErrorPrintf(
      "#ASSERT(%s):%s/%s:%d:%s\nret=%p\n",
  ...
  *(_DWORD *)args = YS::OBJ::can_look(v5, (YS::OBJ_117 *)*(unsigned int *)(v4 + 4));
}
// 50041C: variable 'back_chain' is possibly undefined
->
/----- (0000000000445D98) ----------------------------------------------------
bool __fastcall YS::OBJ::can_look(YS::OBJ_117 *a1)
{
