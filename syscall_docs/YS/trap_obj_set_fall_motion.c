...
---
---
push unk1 ; (unknown)  (pushFromFSp: 0,4,8) (pushFromPSpVal: 0,144,20) (pushFromPSp: 16)
push unk2 ; (unknown)  (pushImm: -1,154,253,258,4) (pushFromFSp: 88)
...
/----- (00000000004FE1EC) ----------------------------------------------------
void __fastcall YS::trap_obj_set_fall_motion(BD_VALUE_21 *args)
{
  __int64 v2; // r29
  ...
  *(_DWORD *)(*(unsigned int *)(v2 + 4) + 0x100LL) = *(_DWORD *)&(*args)[4];
}
// 4FE210: variable 'back_chain' is possibly undefined
